	...
	exports.ControlChange = function() {
		...
		*/
		...
		Object.defineProperty(ControlChange.prototype, "time", {
			...
			set: function(t) {
				this.ticks = privateHeaderMap.get(this).secondsToTicks(t);
			},
			enumerable: false,
			configurable: true
		});
	...
	*/
	...
	exports.Note = function() {
		...
		Object.defineProperty(Note.prototype, "duration", {
			...
			set: function(d) {
				this.durationTicks = privateHeaderMap.get(this).secondsToTicks(this.time + d) - this.ticks;
			},
			enumerable: false,
			configurable: true
		});
...
var require_Encode = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var array_flatten_1 = (init_dist_es2015(), __toCommonJS(dist_es2015_exports));
